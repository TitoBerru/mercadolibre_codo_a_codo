...
window.addEventListener('load', function () {                      
    ...
    formulario.addEventListener('submit', function (e) {
        ...
        let erroresDeRegistro = [];                                

        // // Validacion de Usuario //
        let campoUsuario = document.querySelector('input.login-name')
        ...
        else if (campoPassword.value.length > 50) {
            erroresDeRegistro.push("La contraseña no podrá tener mas de 50 caracteres")
        }
        ...
        if (erroresDeRegistro.length > 0) {
            ...
            let ulErrores = document.querySelector('.span-validation')
            ulErrores.innerHTML = ''
...
// Dejo estas validaciones para cuando avance en el proyecto de codo a codo aunq aun no se si seran necesarias.
